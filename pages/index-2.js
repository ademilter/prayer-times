...
//     const dasd = 'dd.LL.yyyy hh:mm'
//     const todayImsak = DateTime.fromFormat(
//       `${today.MiladiTarihKisaIso8601} ${today.Imsak}`,
//       dasd
//     )
//     const todayGunes = DateTime.fromFormat(
//       `${today.MiladiTarihKisaIso8601} ${today.Gunes}`,
//       dasd
//     )
//     const todayOgle = DateTime.fromFormat(
//       `${today.MiladiTarihKisaIso8601} ${today.Ogle}`,
//       dasd
//     )
//     const todayIkindi = DateTime.fromFormat(
//       `${today.MiladiTarihKisaIso8601} ${today.Ikindi}`,
//       dasd
//     )
//     const todayAksam = DateTime.fromFormat(
//       `${today.MiladiTarihKisaIso8601} ${today.Aksam}`,
//       dasd
//     )
//     const todayYatsi = DateTime.fromFormat(
//       `${today.MiladiTarihKisaIso8601} ${today.Yatsi}`,
//       dasd
//     )
//     const tomorrowImsak = DateTime.fromFormat(
//       `${tomorrow.MiladiTarihKisaIso8601} ${tomorrow.Imsak}`,
//       'dd.LL.yyyy hh:mm'
//     )
//
//     const isImsak = Interval.fromDateTimes(todayImsak, todayGunes).contains(now)
//     const isGunes = Interval.fromDateTimes(todayGunes, todayOgle).contains(now)
//     const isOgle = Interval.fromDateTimes(todayOgle, todayIkindi).contains(now)
//     const isIkindi = Interval.fromDateTimes(todayIkindi, todayAksam).contains(
//       now
//     )
//     const isAksam = Interval.fromDateTimes(todayAksam, todayYatsi).contains(now)
//
//     let nowTime
//
//     if (isImsak)
//       nowTime = { current: 'Imsak', next: 'Gunes', nextDate: todayGunes }
//     else if (isGunes)
//       nowTime = { current: 'Gunes', next: 'Ogle', nextDate: todayOgle }
//     else if (isOgle)
//       nowTime = { current: 'Ogle', next: 'Ikindi', nextDate: todayIkindi }
//     else if (isIkindi)
//       nowTime = { current: 'Ikindi', next: 'Aksam', nextDate: todayAksam }
//     else if (isAksam)
//       nowTime = { current: 'Aksam', next: 'Yatsi', nextDate: todayYatsi }
//     else nowTime = { current: 'Yatsi', next: 'Imsak', nextDate: tomorrowImsak }
//
//     timeSet(nowTime)
//     const a = nowTime.nextDate
